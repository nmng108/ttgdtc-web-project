                ...
                <div class="row justify-content-center align-self-center">
                    ...
                    ?>
                        <div class="col-sm-4 " style="width: 20rem;">
                            <div class="card mb-4 box-shadow " style="background-color: #87CEFF;">
                                        ...
                                        <form method="post" onsubmit="return false">
                                            <div class="btn-group row">
                                                ...
                                                <button type="<?php 
                                                            ...
                                                            ?>"
                                                        style = "width: 50%; margin-left: 10px; background-color: white; color: black"
                                                ...
                                                <span id="quantity_<?=$item["itemCode"]?>">Số lượng còn trong kho: <?=$item['availableQuantity']?></span>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row justify-content-center align-self-center">
                    ...
                    ?>
                        <div class="col-sm-4 " style="width: 20rem;">
                            <div class="card mb-4 box-shadow " style="background-color: #F5DEB3;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <form method="post" onsubmit="return false">
                                            <div class="panel-col">
                                                ...
                                                <input class=" form-control" style="width: 40px;" name="quantity" id="quantity_input_<?=$item["itemCode"]?>" type="number" min="1" max="<?=$item['availableQuantity']?>" value="1" required/>
                                                </div>
                                            ...
                                            <span class="row" id="quantity_<?=$item["itemCode"]?>">Số lượng còn trong kho: <?=$item['availableQuantity']?>)</span>
