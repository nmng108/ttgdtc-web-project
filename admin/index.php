...
<html>
    ...
    <body>
        <section class="header">
            <nav>
                <a href="index.php"><img src="image/logovnu.png"></a>
            ...
            <div class = "text-box">
                <h1>WELCOME TO THE VIETNAM NATIONAL UNIVERSITY</h1>
                <p>
                    Chào mừng bạn đến với trung tâm giáo dục thể chất Đại học Quốc gia Hà Nội
                </p>
                <a href="authen/login.php" class="hero-btn">Login</a>
                <a href="authen/logout.php" class="hero-btn">Logout</a>
            </div>
